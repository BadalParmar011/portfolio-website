...
class Projects extends Component {
  ...
  render () {
    ...
    return (
      <Paper className="d11">
        <Card className="e11">
          <CardHeader title="Projects Developed" className="i12"/>
        </Card>
        <CardContent className="f11">
          <div className={classes.margin}>
            <Grid container spacing={0} alignItems="center" lg={12} className="h11">
              <Grid item xs={12} lg={12} className="bgg1">
                <h5>Project 1</h5>
              </Grid>
              <Grid item md={12} sm={12} xs={12} lg={12} className="g11">
                <TextField
                  margin="dense"
                  variant="outlined"
                  name="title1"
